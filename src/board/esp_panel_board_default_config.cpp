...
const BoardConfig ESP_PANEL_BOARD_DEFAULT_CONFIG = {
    ...
    .stage_callbacks = {
        ...
        [](void *p) -> bool ESP_PANEL_BOARD_EXPANDER_PRE_BEGIN_FUNCTION(p),
#else
        nullptr,
#endif // ESP_PANEL_BOARD_EXPANDER_PRE_BEGIN_FUNCTION
#ifdef ESP_PANEL_BOARD_EXPANDER_POST_BEGIN_FUNCTION
        [](void *p) -> bool ESP_PANEL_BOARD_EXPANDER_POST_BEGIN_FUNCTION(p),
#else
        nullptr,
        ...
        [](void *p) -> bool ESP_PANEL_BOARD_TOUCH_PRE_BEGIN_FUNCTION(p),
#else
        nullptr,
#endif // ESP_PANEL_BOARD_TOUCH_PRE_BEGIN_FUNCTION
#ifdef ESP_PANEL_BOARD_TOUCH_POST_BEGIN_FUNCTION
        [](void *p) -> bool ESP_PANEL_BOARD_TOUCH_POST_BEGIN_FUNCTION(p),
#else
        nullptr,
