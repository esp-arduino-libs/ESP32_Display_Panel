...
#if defined(ESP_PANEL_BOARD_TOUCH_I2C_SDA_PULLUP) && defined(ESP_PANEL_BOARD_TOUCH_I2C_SCL_PULLUP)
    #if ESP_PANEL_BOARD_TOUCH_I2C_SDA_PULLUP != ESP_PANEL_BOARD_TOUCH_I2C_SCL_PULLUP
        #error "`ESP_PANEL_BOARD_TOUCH_I2C_SDA_PULLUP` and `ESP_PANEL_BOARD_TOUCH_I2C_SCL_PULLUP` must be the same"
    #elif !defined(ESP_PANEL_BOARD_TOUCH_I2C_INTERNAL_PULLUP)
        #define ESP_PANEL_BOARD_TOUCH_I2C_INTERNAL_PULLUP ESP_PANEL_BOARD_TOUCH_I2C_SDA_PULLUP
    #endif
#endif
#if defined(ESP_PANEL_BOARD_EXPANDER_I2C_SDA_PULLUP) && defined(ESP_PANEL_BOARD_EXPANDER_I2C_SCL_PULLUP)
    #if ESP_PANEL_BOARD_EXPANDER_I2C_SDA_PULLUP != ESP_PANEL_BOARD_EXPANDER_I2C_SCL_PULLUP
        #error "`ESP_PANEL_BOARD_EXPANDER_I2C_SDA_PULLUP` and `ESP_PANEL_BOARD_EXPANDER_I2C_SCL_PULLUP` must be the same"
    #elif !defined(ESP_PANEL_BOARD_EXPANDER_I2C_INTERNAL_PULLUP)
        #define ESP_PANEL_BOARD_EXPANDER_I2C_INTERNAL_PULLUP ESP_PANEL_BOARD_EXPANDER_I2C_SDA_PULLUP
    #endif
#endif
