...
static esp_err_t esp_lcd_touch_new_i2c_gt911(const esp_lcd_panel_io_handle_t io, const esp_lcd_touch_config_t *config, esp_lcd_touch_handle_t *out_touch);
...
static esp_err_t esp_lcd_touch_new_i2c_gt911(const esp_lcd_panel_io_handle_t io, const esp_lcd_touch_config_t *config, esp_lcd_touch_handle_t *out_touch)
{
    ...
    esp_lcd_touch_handle_t esp_lcd_touch_gt911 = (esp_lcd_touch_handle_t)heap_caps_calloc(1, sizeof(esp_lcd_touch_t), MALLOC_CAP_DEFAULT);
...
static esp_err_t esp_lcd_touch_gt911_read_data(esp_lcd_touch_handle_t tp)
{
    ...
    if ((buf[0] & 0x80) == 0x00) {
        ...
        touch_cnt = (touch_cnt > LCD_TOUCH_MAX_POINTS ? LCD_TOUCH_MAX_POINTS : touch_cnt);
