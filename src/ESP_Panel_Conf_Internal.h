...
/* If "ESP_Panel_Conf.h" and "ESP_Panel_*_Board.h" are available from here, try to use them later */
#ifdef __has_include
...
/* If "ESP_Panel_Conf.h" and "ESP_Panel_*_Board.h" are not skipped, include them */
    ...
    #else
        #include "../ESP_Panel_Conf.h"                   /* Or include internal configuration */
    #endif
