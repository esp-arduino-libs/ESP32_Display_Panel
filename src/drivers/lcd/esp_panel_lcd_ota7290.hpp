...
/**
 * @brief LCD driver class for OTA7290 display controller
 *
 */
class LCD_OTA7290: public LCD {
public:
    /**
     * @brief Default basic attributes for OTA7290 LCD controller
     */
     ...
     */
    LCD_OTA7290(Bus *bus, int width, int height, int color_bits, int rst_io):
     ...
     */
    LCD_OTA7290(Bus *bus, const Config &config):
     ...
     * @note Vendor initialization commands may vary between manufacturers. Consult LCD supplier for them
     */
    LCD_OTA7290(const BusFactory::Config &bus_config, const Config &lcd_config):
     ...
     */
    [[deprecated("Use other constructor instead")]]
    LCD_OTA7290(Bus *bus, uint8_t color_bits = 0, int rst_io = -1): LCD_OTA7290(bus, 0, 0, color_bits, rst_io)
    {
    }
...
/**
 * @brief Alias for backward compatibility
 * @deprecated Use `esp_panel::drivers::LCD_OTA7290` instead
 */
using ESP_PanelLcd_OTA7290 [[deprecated("Use `esp_panel::drivers::LCD_OTA7290` instead")]] =
    esp_panel::drivers::LCD_OTA7290;
