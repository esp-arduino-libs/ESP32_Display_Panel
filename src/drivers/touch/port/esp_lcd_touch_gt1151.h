...
#define ESP_LCD_TOUCH_GT1151_VER_MAJOR    (1)
#define ESP_LCD_TOUCH_GT1151_VER_MINOR    (0)
#define ESP_LCD_TOUCH_GT1151_VER_PATCH    (5)
 ...
 *
 */
#define ESP_LCD_TOUCH_IO_I2C_GT1151_CONFIG(freq_hz)             \
    {                                                    \
