...
{
    ESP_LOGI(TAG, "version: %d.%d.%d", ESP_LCD_TOUCH_SPD2010_VER_MAJOR, ESP_LCD_TOUCH_SPD2010_VER_MINOR,
             ESP_LCD_TOUCH_SPD2010_VER_PATCH);
...
#endif // ESP_PANEL_DRIVERS_TOUCH_ENABLE_SPD2010
