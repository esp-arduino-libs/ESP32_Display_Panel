...
#include "drivers/esp_panel_drivers_conf_internal.h"
    ...
    */
        ...
        #define ESP_PANEL_DRIVERS_EXPANDER_USE_WAVESHARE_LCD_4_CH32V003 (1)
    #else
        ...
        #ifndef ESP_PANEL_DRIVERS_EXPANDER_USE_WAVESHARE_LCD_4_CH32V003
            #ifdef CONFIG_ESP_PANEL_DRIVERS_EXPANDER_USE_WAVESHARE_LCD_4_CH32V003
                #define ESP_PANEL_DRIVERS_EXPANDER_USE_WAVESHARE_LCD_4_CH32V003 CONFIG_ESP_PANEL_DRIVERS_EXPANDER_USE_WAVESHARE_LCD_4_CH32V003
            #else
                #define ESP_PANEL_DRIVERS_EXPANDER_USE_WAVESHARE_LCD_4_CH32V003 (0)
            #endif
        #endif
...
#ifndef ESP_PANEL_DRIVERS_EXPANDER_ENABLE_WAVESHARE_LCD_4_CH32V003
    #if ESP_PANEL_DRIVERS_EXPANDER_USE_WAVESHARE_LCD_4_CH32V003
        #define ESP_PANEL_DRIVERS_EXPANDER_ENABLE_WAVESHARE_LCD_4_CH32V003  (1)
    #else
        #define ESP_PANEL_DRIVERS_EXPANDER_ENABLE_WAVESHARE_LCD_4_CH32V003  (0)
    #endif
#endif
