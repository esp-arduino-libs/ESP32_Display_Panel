...
#include "base/esp_lcd_axs15231b.h"
 ...
 */
class ESP_PanelLcd_AXS15231B: public ESP_PanelLcd {
public:
    /**
     ...
     */
    ESP_PanelLcd_AXS15231B(ESP_PanelBus *bus, uint8_t color_bits, int rst_io = -1);
     ...
     */
    ESP_PanelLcd_AXS15231B(ESP_PanelBus *bus, const esp_lcd_panel_dev_config_t &panel_config);

    /**
     * @brief Destroy the LCD device
     *
     */
    ~ESP_PanelLcd_AXS15231B() override;
