...
public:
     ...
     */
    ESP_PanelLcd_GC9A01(ESP_PanelBus *bus, uint8_t color_bits, int rst_io = -1);
     ...
     */
    ESP_PanelLcd_GC9A01(ESP_PanelBus *bus, const esp_lcd_panel_dev_config_t &panel_config);
