...
ESP_PanelLcd_GC9B71::ESP_PanelLcd_GC9B71(ESP_PanelBus *bus, int color_bits, int rst_io,
...
void ESP_PanelLcd_GC9B71::init(void)
{
    CHECK_NULL_RETURN(bus);
    CHECK_ERROR_RETURN(esp_lcd_new_panel_gc9b71(bus->getHandle(), &panel_config, &handle));
}
